			...
			<Container>
				<div className="max-w-5xl mx-auto text-center mb-12 text-primary">
					...
					<h2 className="text-3xl md:text-4xl font-bold mb-4">
						Become a Part of Our Innovation Hub
					</h2>
					<p className="text-xl text-muted-foreground mb-8 p-3">
						Join a vibrant community of innovators, creators, and visionaries at
						<span className="font-bold"> Made in AASTU</span>. Gain access to
						resources, mentorship, and opportunities to turn your ideas into
						impactful solutions.
